---
name: artifact-template-game-feature-design-simple
description: "Create a document using the Game Feature Design Simple template and its retained reference file. Use when the user selects this template, names Game Feature Design Simple, or explicitly invokes $artifact-template-game-feature-design-simple. Create a concise implementation-ready Word-only game feature document with a page-based UE total flow, editable Penpot diagrams, PNG review images, and DOCX as the only formal document deliverable."
---

# Game Feature Design Simple
